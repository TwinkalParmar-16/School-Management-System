...
public class Student_pageController implements Initializable {
    ...
    private void show_notification(ActionEvent event) {
        ...
        AnchorPane root = (AnchorPane)FXMLLoader.load(getClass().getResource("stu_notification.fxml"));
        Stage dashboardstage= new Stage();
        dashboardstage.setTitle("student_page/stu_notification");
    ...
    private void show_timetable(ActionEvent event) {
        ...
        Stage dashboardstage= new Stage();
        dashboardstage.setTitle("student_page/show_timetable");
        Scene scene = new Scene(root,997,747);
        dashboardstage.setScene(scene);
        dashboardstage.show();
        //System.out.println("Ye chla");
    ...
    private void update_password(ActionEvent event) {
        ...
        AnchorPane root = (AnchorPane)FXMLLoader.load(getClass().getResource("student_password.fxml"));
        Stage dashboardstage= new Stage();
        dashboardstage.setTitle("student_page/student_password");
